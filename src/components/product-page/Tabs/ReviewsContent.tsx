...
const ReviewsContent = () => {
  return (
    <section>
      {/* Header section with review count */}
      <div className="flex items-center justify-between flex-col sm:flex-row mb-5 sm:mb-6">
        ...
        {/* Dropdown for sorting and 'Write a Review' button */}
        <div className="flex items-center space-x-2.5">
          {/* Select dropdown for review sorting */}
      ...
      {/* Displaying all the reviews in a grid layout */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5 sm:mb-9">
        
        {/* Looping through reviews and rendering ReviewCard for each */}
